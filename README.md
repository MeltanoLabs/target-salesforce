...
```
Failed records for update Budget__c (job 750xx0000000001AAA): 2200 UNABLE_TO_LOCK_ROW (e.g. a0Bxx0000000001AAA: unable to obtain exclusive access to this record or 200 records: 001xx0000000001AAA,001xx0000000002AAA, ... (198 more)); 584 INVALID_CROSS_REFERENCE_KEY (e.g. a0Bxx0000000201AAA: invalid cross reference id). CSV: /tmp/target-salesforce-h3k9vq2a.csv
```
